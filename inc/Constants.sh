...
#   . /usr/local/SleepWarden/inc/Constants.sh
#
...
then
  ...
  # Sets the following SleepWarden globals:
  #
  #  GLB_sv_ProjectName                     - Project name (SleepWarden)
  ...
  #
  #  GLB_iv_MaxLogSizeBytes                 - Maximum length of SleepWarden log(s)
  ...
  #
  #  Key:
  #    GLB_ - SleepWarden global variable
  #
  ...
  GLB_sv_ProjectName="SleepWarden"
  GLB_sv_ProjectInitials="SW"
